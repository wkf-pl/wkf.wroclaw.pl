...
const adminIconPaths: Record<string, string[]> = {
  ...
  footer: ['M3 4h14v12H3z', 'M3 12h14 M6 15h.01 M9 15h.01'],
  'homepage-hero': ['M3 4h14v12H3z', 'm4 12 2.75-3 2.25 2.25 1.5-1.5L16 14'],
  'homepage-sections': ['M3 4h6v5H3z M11 4h6v5h-6z M3 11h6v5H3z M11 11h6v5h-6z'],
